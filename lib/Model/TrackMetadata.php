 ...
 */
class TrackMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackMetadata';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mbid_mapping', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['mbid_mapping'];
    }
     ...
     * @return self
     */
    public function setMbidMapping($mbid_mapping)
    {
        if (is_null($mbid_mapping)) {
            throw new \InvalidArgumentException('non-nullable mbid_mapping cannot be null');
        }
        $this->container['mbid_mapping'] = $mbid_mapping;
