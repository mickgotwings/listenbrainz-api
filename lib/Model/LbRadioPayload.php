 ...
 */
class LbRadioPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'lbRadio_payload';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('jspf', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['jspf'] === null) {
            $invalidProperties[] = "'jspf' can't be null";
        }
     ...
     * @return self
     */
    public function setJspf($jspf)
    {
        if (is_null($jspf)) {
            throw new \InvalidArgumentException('non-nullable jspf cannot be null');
        }
        $this->container['jspf'] = $jspf;
