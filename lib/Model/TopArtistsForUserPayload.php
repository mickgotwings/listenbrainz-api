...
/**
 * TopArtistsForUserPayload Class Doc Comment
 *
 * @category Class
 * @package  Listenbrainz
 * @author   OpenAPI Generator team
 ...
 */
class TopArtistsForUserPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'topArtistsForUser_payload';
    ...
    protected static $setters = [
        ...
        'range' => 'setRange',
        'to_ts' => 'setToTs',
        'total_artist_count' => 'setTotalArtistCount',
        'user_id' => 'setUserId'
    ];
    ...
    protected static $getters = [
        ...
        'range' => 'getRange',
        'to_ts' => 'getToTs',
        'total_artist_count' => 'getTotalArtistCount',
        'user_id' => 'getUserId'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('total_artist_count', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['total_artist_count'] === null) {
            $invalidProperties[] = "'total_artist_count' can't be null";
        }
     ...
     * Sets artists
     *
     * @param \Listenbrainz\Model\TopArtistsForUserPayloadArtistsInner[] $artists artists
     *
     * @return self
     */
    ...
    /**
     * Gets total_artist_count
     *
     * @return int
     */
    public function getTotalArtistCount()
    {
        return $this->container['total_artist_count'];
    }

    /**
     * Sets total_artist_count
     *
     * @param int $total_artist_count total_artist_count
     *
     * @return self
     */
    public function setTotalArtistCount($total_artist_count)
    {
        if (is_null($total_artist_count)) {
            throw new \InvalidArgumentException('non-nullable total_artist_count cannot be null');
        }
        $this->container['total_artist_count'] = $total_artist_count;
