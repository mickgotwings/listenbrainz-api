 ...
 */
class ArtistMapForUserPayloadArtistMapInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'artistMapForUser_payload_artist_map_inner';
