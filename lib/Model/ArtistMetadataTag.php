 ...
 */
class ArtistMetadataTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'artistMetadata_tag';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['artist'] === null) {
            $invalidProperties[] = "'artist' can't be null";
        }
