 ...
 */
class TopReleaseGroupsForArtistInnerRelease implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'topReleaseGroupsForArtist_inner_release';
