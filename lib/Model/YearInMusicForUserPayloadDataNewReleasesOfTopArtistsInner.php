 ...
 */
class YearInMusicForUserPayloadDataNewReleasesOfTopArtistsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'yearInMusicForUser_payload_data_new_releases_of_top_artists_inner';
    ...
    protected static $setters = [
        'artist_credit_mbids' => 'setArtistCreditMbids',
    ...
    protected static $getters = [
        'artist_credit_mbids' => 'getArtistCreditMbids',
    ...
    {
        $this->setIfExists('artist_credit_mbids', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets artist_credit_mbids
     *
     * @return string[]|null
     */
    public function getArtistCreditMbids()
    {
        return $this->container['artist_credit_mbids'];
    }

    /**
     * Sets artist_credit_mbids
     *
     * @param string[]|null $artist_credit_mbids artist_credit_mbids
     *
     * @return self
     */
    public function setArtistCreditMbids($artist_credit_mbids)
    {
        if (is_null($artist_credit_mbids)) {
            throw new \InvalidArgumentException('non-nullable artist_credit_mbids cannot be null');
        }
        $this->container['artist_credit_mbids'] = $artist_credit_mbids;
