 ...
 */
class ColorPayloadReleasesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'color_payload_releases_inner';
