...
/**
 * ColorPayloadReleasesInnerRecordingsInnerTrackMetadataAdditionalInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ColorPayloadReleasesInnerRecordingsInnerTrackMetadataAdditionalInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'color_payload_releases_inner_recordings_inner_track_metadata_additional_info';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recording_mbid'] === null) {
            $invalidProperties[] = "'recording_mbid' can't be null";
        }
        if ($this->container['release_mbid'] === null) {
            $invalidProperties[] = "'release_mbid' can't be null";
        }
     ...
     * Sets recording_mbid
     *
     * @param string $recording_mbid recording_mbid
     *
     * @return self
     */
     ...
     * Sets release_mbid
     *
     * @param string $release_mbid release_mbid
     *
     * @return self
     */
