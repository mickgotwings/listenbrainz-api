...
/**
 * RecordingFeedbackRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecordingFeedbackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'recordingFeedback_request';
    ...
    */
    ...
    public function setScore($score)
    {
        ...
        if (($score > 1)) {
            throw new \InvalidArgumentException('invalid value for $score when calling RecordingFeedbackRequest., must be smaller than or equal to 1.');
        }
        if (($score < -1)) {
            throw new \InvalidArgumentException('invalid value for $score when calling RecordingFeedbackRequest., must be bigger than or equal to -1.');
        }
