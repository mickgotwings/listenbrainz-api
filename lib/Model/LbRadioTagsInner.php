...
/**
 * LbRadioTagsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LbRadioTagsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'lbRadioTags_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tag_count', $data ?? [], null);
    }
    ...
    */
    ...
    public function setTagCount($tag_count)
    {
        if (is_null($tag_count)) {
            throw new \InvalidArgumentException('non-nullable tag_count cannot be null');
        }
