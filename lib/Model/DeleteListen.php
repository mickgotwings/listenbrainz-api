...
/**
 * DeleteListen Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeleteListen implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deleteListen';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['listened_at'] === null) {
            $invalidProperties[] = "'listened_at' can't be null";
        }
     ...
     * Sets listened_at
     *
     * @param int $listened_at listened_at
     *
     * @return self
     */
