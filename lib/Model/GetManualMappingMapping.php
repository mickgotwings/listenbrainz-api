...
/**
 * GetManualMappingMapping Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetManualMappingMapping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getManualMapping_mapping';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recording_msid'] === null) {
            $invalidProperties[] = "'recording_msid' can't be null";
        }
     ...
     * Sets recording_msid
     *
     * @param string $recording_msid recording_msid
     *
     * @return self
     */
