 ...
 */
class FeedEventsPayloadEventsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'feedEvents_payload_events_inner';
