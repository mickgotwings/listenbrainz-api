 ...
 */
class PlayingNowForUserPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'playingNowForUser_payload';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['listens'] === null) {
            $invalidProperties[] = "'listens' can't be null";
        }
        if ($this->container['playing_now'] === null) {
            $invalidProperties[] = "'playing_now' can't be null";
        }
     ...
     * Sets playing_now
     *
     * @param bool $playing_now playing_now
     *
     * @return self
     */
