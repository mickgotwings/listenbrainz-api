 ...
 */
class SubmitListensPayloadInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'submitListens_payload_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['listened_at']) && ($this->container['listened_at'] < 0)) {
            $invalidProperties[] = "invalid value for 'listened_at', must be bigger than or equal to 0.";
        }
    ...
    public function setListenedAt($listened_at)
    {
        ...
        if (($listened_at < 0)) {
            throw new \InvalidArgumentException('invalid value for $listened_at when calling SubmitListensPayloadInner., must be bigger than or equal to 0.');
        }
