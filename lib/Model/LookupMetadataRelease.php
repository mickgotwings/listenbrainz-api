...
/**
 * LookupMetadataRelease Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LookupMetadataRelease implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'lookup_metadata_release';
    ...
    protected static $setters = [
        'album_artist_name' => 'setAlbumArtistName',
        'caa_id' => 'setCaaId',
    ...
    protected static $getters = [
        'album_artist_name' => 'getAlbumArtistName',
        'caa_id' => 'getCaaId',
    ...
    {
        $this->setIfExists('album_artist_name', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets album_artist_name
     *
     * @return string|null
     */
    public function getAlbumArtistName()
    {
        return $this->container['album_artist_name'];
    }

    /**
     * Sets album_artist_name
     *
     * @param string|null $album_artist_name album_artist_name
     *
     * @return self
     */
    public function setAlbumArtistName($album_artist_name)
    {
        if (is_null($album_artist_name)) {
            throw new \InvalidArgumentException('non-nullable album_artist_name cannot be null');
        }
        $this->container['album_artist_name'] = $album_artist_name;
