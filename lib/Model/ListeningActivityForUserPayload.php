 ...
 */
class ListeningActivityForUserPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listeningActivityForUser_payload';
